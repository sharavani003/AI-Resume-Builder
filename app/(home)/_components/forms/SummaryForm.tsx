...
//       const parsedResponse: GeneratesSummaryType = {
//         summaries: Object.entries(JSON.parse(responseText)).map(
//           ([experienceLevel, summary]) => ({
//             experienceLevel,
//             summary,
//           })
//         ),
...
//         {aiGeneratedSummary?.summaries?.length ? (
//           <div>
...
interface GeneratesSummaryType {
  summaries: { experienceLevel: string; summary: string }[];
}
